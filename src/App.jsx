...
import { Mail, Phone, MapPin, Linkedin, CheckCircle2, Award, GraduationCap } from 'lucide-react';
...
const App = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F4F4F4] py-10 font-sans print:py-0 print:bg-white text-gray-800 flex justify-center">
      ...
      */}
      <div 
        className="w-full max-w-[1000px] bg-white shadow-2xl overflow-hidden relative print:shadow-none print:max-w-none print:w-full"
      ...
      >
        ...
        {/* Header Area */}
        <header className="px-6 md:px-10 pt-12 pb-8 flex flex-col items-center text-center border-b border-gray-100 print:px-6 print:pt-8 print:pb-4">
          ...
          <div 
            className="text-xs md:text-base font-bold uppercase tracking-[0.2em]"
        ...
        <div className="grid grid-cols-1 md:grid-cols-[1fr_2.2fr] print:grid-cols-[1fr_2.2fr]">
          ...
          {/* LEFT SIDEBAR */}
          <aside className="bg-gray-50 p-6 md:p-10 print:p-6 border-r border-gray-100">
            ...
            <section className="mb-8">
              ...
              <ul className="space-y-3 text-sm text-gray-600 break-all">
                <li className="flex items-center gap-3">
                  <Mail size={16} className="shrink-0" style={{ color: mLightBlue }} />
                  <span>ramiro.calahorrano@gmail.com</span>
                </li>
                <li className="flex items-center gap-3">
                  <Phone size={16} className="shrink-0" style={{ color: mLightBlue }} />
                  <span>+36-20-27-81374</span>
                </li>
                <li className="flex items-center gap-3">
                  <MapPin size={16} className="shrink-0" style={{ color: mLightBlue }} />
                  <span>Debrecen, Hungary</span>
                </li>
                <li className="flex items-center gap-3">
                  <Linkedin size={16} className="shrink-0" style={{ color: mLightBlue }} />
            ...
            <section className="mb-8">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li className="flex items-start gap-2"><CheckCircle2 size={16} className="mt-0.5 shrink-0" style={{ color: mDarkBlue }} /> Laboratory Mgmt & Leadership</li>
                <li className="flex items-start gap-2"><CheckCircle2 size={16} className="mt-0.5 shrink-0" style={{ color: mDarkBlue }} /> Quality Assurance (ISO 17025)</li>
                <li className="flex items-start gap-2"><CheckCircle2 size={16} className="mt-0.5 shrink-0" style={{ color: mDarkBlue }} /> Tech Cleanliness & Metrology</li>
                <li className="flex items-start gap-2"><CheckCircle2 size={16} className="mt-0.5 shrink-0" style={{ color: mDarkBlue }} /> Process Optimization (Chemometrics)</li>
                <li className="flex items-start gap-2"><CheckCircle2 size={16} className="mt-0.5 shrink-0" style={{ color: mDarkBlue }} /> Logistics Coordination</li>
              </ul>
            </section>
          ...
          {/* RIGHT MAIN CONTENT */}
          <main className="p-6 md:p-10 print:p-6 bg-white">
